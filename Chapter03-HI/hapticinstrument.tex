...
This study was small but seminal: we found mHIVE was effective for exploration but not refinement, which lead to distinguishing the design activities of \emph{sketch} and \emph{refine}.
...
and is operated with a single-touch tablet-based interface (\autoref{fig:StudySetup}). 
