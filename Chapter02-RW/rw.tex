...
Designs can connect with users at multiple levels: visceral (\eg, emotional) appeal, behavioural (\eg, usability), and reflective (\eg, intellectual)  \cite{Norman2004}.
While we will show usability improvements from haptic interfaces, touch is especially connected to visceral impressions.
Marketing research has studied multiple ways that touch can connect with customers: it can encourage someone to chose a phone that feels better over one that might work better, and persuade customers to shop at stores that let them touch products \cite{Spence2011,Jansson-Boyd2011}.
...
Two especially common models are Ekman's basic emotions and Russel's affect grid.
...
Russell's affect grid \cite{Russell1989,Russell1989a} separates emotions into dimensions of arousal (low to high energy) and valence (positive and negative emotions); this work informs much of our work on expressivity and especially the CuddleBit work in \autoref{ch:applications:cuddlebit}.
Other researchers often uses these to frame their work.
...
\subsection{Expressive Communication}
