...
Haptic displays an be combined for more convincing results \cite{Okamura1998}.
An excellent overview of these senses is available by \citet{Lederman2009survey}, and a practical introduction to the technology is available by \citet{Hayward2007}.
...
As of writing (2016), this type of actuator is increasingly deployed in mobile contexts (\eg Apple's Taptic engine).
...
Actuators like VT devices can be used alone or put together spatial multiactuator displays like seats \cite{Israr2012,Israr2010}, belts \cite{Pielot2009,Paneels2013}, wristbands \cite{Arab2015,Paneels2013}, vests \cite{Prasad2014,Jones2004}, and gloves \cite{Park2016,Kim2009}.
These can be arrange into grids [] to provide explicit spatial input.

As with vision, illusions play a valuable role in \haxd.
...
\osC{todo: explain why these are important, what the illusions are}
...
Surface friction can be manipulated by both mechanical motion or electrical adhesion.
