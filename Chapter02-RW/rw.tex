...
Our early qualitative approach helps us iterate on our design tools and generate an initial theory of haptic experience design.
Once generated, quantitative methods become more appropriate to test hypotheses and generalize from the in-depth findings from a few design instances to larger-scale feedback.
Our quantitative metrics start to emerge in \autoref{ch:tactileanimation}, but especially are found in \autoref{ch:macaron} and \autoref{ch:hapturk}, with the use of online data collection.

HapTurk, Macaron logging, etc.
