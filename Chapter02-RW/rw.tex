...
These can be arrange into grids, either dense tactile pixels (``taxels") \cite{Kim2009} or sparse arrays \cite{Israr2012,Israr2010}, to provide 2D output on a plane.
...
We distinguish proprioception from the related term kinaesthetic by being the general, synthesized sense, where kinaesthetic sensation is strictly the sense of motion \osC{KM: make sure this is correct}.
...
Like the stroboscopic effect transforming a series of images into the perception of motion for visual displays, illusions play a valuable role in haptic sensations \cite{Hayward2016}.
...
While realistic virtual environments for force-feedback haptic feedback is helpful in medical or training applications  \cite{Okamura2009,VanDerMeijden2009}, we focus on applications that find increased value in an explicit design step.
...
Design has an increasingly studied topic in non-haptic contexts, providing both guidelines and inspiration for \haxd.
...
We explore informal collaboration briefly in \autoref{ch:hapticinstrument}, and explore the design activity of \emph{sharing} in more detail in Chapters \ref{ch:hapturk} and \ref{ch:applications}.
