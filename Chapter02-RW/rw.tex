...
We focus our coverage on the sensations directly studied \revFinalKM{within} this dissertation \revRG{(vibrotactile feedback, programmable friction, simple force-feedback, simple haptic robots)}, while also portraying the diversity of haptic experiences and technology.
...
\revRG{Rhythm opens up a large, learnable design space;  \revFinalKM{users can discern between \cite{Ternes2008} and learn \cite{Swerdfeger2009thesis}} 84 different rhythmic icons.} %  and can be applied with even light, low-cost rumble motors.}
...
%
%%%%%%%%%%%%
\section{Non-Haptic Design and Creativity \revFinalKM{Support}}
...
\label{sec:rw:designresearch}
\revFinal{
The HCI community is actively exploring the relationships between design and research\revFinalKM{, which} are intertwined for interactive systems.
Current discourse revolves around how HCI research can draw \revFinalKM{generalizable} knowledge from design methods, and how knowledge gained from research can inform design practice.
}
...
\revFinalKM{This final approach -- RtD -- is the kind we use most in this dissertation.}
}

\revFinal{
\citet{Zimmerman2007rtd} suggests RtD as a model to \revFinalKM{use design skills to conduct} HCI research.
...
The core value of design in research is its ability to \revFinalKM{simultaneously resolve} ill-posed problems and potential solution spaces \revFinalKM{into a question with a solution}.
Sketching and prototyping remain core techniques to \revFinalKM{supporting interactive dialogue} with a problem \cite{Schon1982}, but \revFinalKM{are valid means of inquiry} when design \revFinalKM{is} embedded within a research context\revFinalKM{, \eg,} ``design-oriented research" \cite{Fallman2003designoriented}.
}
...
\revFinalKM{
We complement RtD with qualitative inquiry, using methods from grounded theory and phenomenology, and quantitative analysis, using statistics and visualization.
We discuss our larger methodological framework in \autoref{sec:rw:methodology}.
}
...
\revFinalKM{We discuss the relationship between design and research in \autoref{sec:rw:designresearch}.}
