...
\osE{Design thinking is a process and approach to solving problems \revRG{\cite{Buxton2007}}.}
...
\osE{The particular blend of methods depended on \revRG{the} project.} %each project.}
