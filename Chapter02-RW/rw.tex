...
\osC{todo: merge (especially this paragraph) with IJHCS RW}
...
\osC{Need to make sure this section highlights the need to design haptic sensations.}
...
\subsection{Accessiblity \osE{and Guidance}}
...
\osE{this is less covered in this dissertation so it's not quite as essential. But, great excuse for LineSpace RW.}

\osE{Higher level question: should there be many shorter sections, or fewer larger sections? Should they all be the same (ish) size?}
