...
These two types of feedback are useful for different purposes, \eg material properties like texture and weight, respectively \cite{Klatzky2013}(?), but can be combined for more convincing results (cite Okamura 1998 or similar).
...
Guidance \cite{Tan2003} back display for guidance, Linderman2005
