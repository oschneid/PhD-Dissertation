...
\osE{Though music lends its vocabulary to touch, describe non-temporal properties remain difficult-to-describe.}
...
\osC{Todo: Final paragraph for methodology summing this all up? Not sure what to say if so.}
