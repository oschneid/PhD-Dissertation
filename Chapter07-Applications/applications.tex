...
\revFinal{
These focused design projects contributed to our inquiry by in three ways:
...
\begin{enumerate}
    ...
    \revFinal{With Feel Messenger, we pushed the limits of existing hardware to create engaging vibrotactile feedback, and understood how to create effective phone vibrations for HapTurk (\autoref{ch:hapturk}).}
    ...
    \revFinal{Voodle and MacaronBit were developed to explore explicitly supporting \emph{sketching} and \emph{refining} supported in a suite of tools.}
\end{enumerate}


\noindent
\osE{Most of this chapter (Sections \ref{sec:applications:feelcraft}-\ref{sec:applications:roughsketch} and \ref{sec:applications:cuddlebit}}\revRG{)}  were primarily presented as demos with associated papers\osE{. As such,} we present \osE{this chapter's work} in a summary format rather than full reproduction\osE{, and exclude prefaces.}
