...
To control CuddleBit behaviour and inform \haxd support tools in this complex domain, we developed two software design tools: MacaronBit and Voodle (\autoref{fig:cuddlebitdesigntools}).
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \begin{subfigure}{\textwidth}
	      ...
	      \label{fig:voodle}
   \end{subfigure}
   \caption{CuddleBit design tools. MacaronBit enables \emph{refining} of affective robot behaviours, while Voodle enables initial \emph{sketching}.}
