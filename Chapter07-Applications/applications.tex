...
Voodle (from ``vocal doodling") is a novel sketching interface to easily create 1-DoF behaviours using non-speech voice, in particular, sub-linguistic ideomorphs \cite{Dingemanse2012} like ``Ooooh" and ``Bwooop."
