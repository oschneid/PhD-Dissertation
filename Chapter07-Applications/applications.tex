...
\revFinalAgain{The TPad Phone was accompanied by a mature API which supported \emph{sketching} for spatial friction profiles: a image could be easily and quickly loaded to create a static profile.
...
\revFinalAgain{This project also revealed the complexities of creating a design language, a set of principles for a consistent look and feel, when designing for haptics.
...
Instead, we found that lessons must be designed around intended modalities, and might be most appropriate when used creatively by students, \ie, with active learning.
