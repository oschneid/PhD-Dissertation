...
\revFinalAgain{The TPad Phone was accompanied by a mature API which supported sketching for static friction profiles: a image could be easily loaded to create profiles.
It was more difficult to sketch complex interactions that reacted to input velocity or multitouch, and refining designs was slow.}
