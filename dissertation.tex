...
\newcommand{\inlineCitation}[1]{\begin{quote}\citeauthor*{#1}. (\usebibentry{#1}{year}). \emph{\usebibentry{#1}{title}}. \usebibentry{#1}{booktitle}.\end{quote}}
...
\bibliography{refs/HA14-CHI2015-SIGGRAPH-add,refs/HA14-CHI2015,refs/HapticDesignChallenges-WHC2015,refs/HI-HS2014-refs,refs/verillo2,refs/proposal-bib,refs/phd-dissertation,refs/oliver-pubs}
\end{singlespace}
