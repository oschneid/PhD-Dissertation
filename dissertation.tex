...
%HapTurk chapter
\newcommand{\concept}[1]{\textcolor{DarkGreen}{#1}}
\newcommand{\affect}[1]{\textcolor{DarkRed}{#1}}
...
%\subtitle{Getting the Feel Right and the Right Feel}
...
%\include{Chapter08-Conclusion/conclusion}
