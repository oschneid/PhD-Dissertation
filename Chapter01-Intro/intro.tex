...
one or more perceived senses of touch, possibly as part of a multimodal or multisensory experience.\footnote{We developed \revOne{these definitions} from our interviews with hapticians (\autoref{ch:hapticianinterviews}).}
\end{quote}
...
To complement our primarily design-based approach and ground it with \revFinalKM{hapticians} in the field, we draw from other data sources: a workshop held at World Haptics 2015 and interviews with \revFinalKM{professional hapticians}.
