...
\begin{figure}[tbh] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=0.6\textwidth]{Mango-Screenshot-Labeled-2015-04-12-1132} 
...
\inlineHeading{Theme 1: Animation Metaphor}
...
\inlineHeading{Theme 2: Tactile Animation Object vs. Vector Sensations}
...
\inlineHeading{Theme 3: Designing-in-action with direct manipulation}
...
\inlineHeading{Theme 4: Replication through Copy and Paste}
...
\section{Discussion}
\osC{TODO: restructure discussion when other chapters are more populated, to connect it better.}
