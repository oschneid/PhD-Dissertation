...
\begin{figure}[t] %  figure placement: here, top, bottom, or page
  ...
  \begin{subfigure}[b]{0.19\textwidth}
    ...
    \end{subfigure}
    	   \caption{Interpolation models used to determine physical actuator output ($A_{1-3}$) from virtual actuator intensity ($A_v$) and barycentric coordinates ($a_{1-3}$).}
...
%   	\includegraphics[clip=true, trim= 1 150 0 7, width=0.4\textwidth]{P2_sound_example-2014-09-22-1630} 
	   	\includegraphics[clip=true, trim= 4 155 0 85, width=0.47\textwidth]{P2_sound_example-2014-09-22-1630} 
...
\theme{2}{Tactile Animation Object vs. Vector Sensations}
...
\begin{figure}[htb] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=0.46\textwidth]{HA14-Applications-Split1-2015-04-14-1025} 
   \caption{Tactile animation could define motion with (a) 1D actuator arrays, (b) dense and sparse VT grids, (c) handhelds.}
   \label{fig:application:space1}
\end{figure}


\begin{figure}[htb] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=0.46\textwidth]{HA14-Applications-Split2-2015-04-14-1025} 
...
and mixed actuator types (such as a chair with both voice coil and rumble motors, \autoref{fig:application:space2}e).
