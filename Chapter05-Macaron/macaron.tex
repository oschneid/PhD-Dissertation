...
Because we explored \haxd tool implementation in-depth in \autoref{ch:tactileanimation}, we knew how to build Macaron; we thus focused on studying the design process\osE{. We} specifically \osE{investigated} how different ways of viewing or reproducing elements of a vibrotactile icon affect design.
