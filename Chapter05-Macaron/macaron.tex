...
We refined our study tasks: participants designed haptic tracks for visual animations.
We based this task on the effective sound-based task in \autoref{ch:tactileanimation}.
We used phenomenology and grounded theory methods augmented by logged user actions and visualized timelines to look at our participants' design process; our participants were generally na\"ive to haptics and media design to complement our previous studies.
We saw the different stages of design, including \emph{browsing}, \emph{sketching}, and iterative \emph{refinement}.
