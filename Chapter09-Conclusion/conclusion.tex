...
\osE{Our case study approach gave us a balance of depth, breadth, and grounded information; our choices for selecting each information source necessarily shape our findings.}
...
\osE{Here, we outline important features that we believe will enable for such a suite}
...
\osE{These ratings provided} an elicitation device, inviting participants to \osE{verbally} comment on the difficulty or their happiness with their designs.
...
\osE{By understanding haptic experience design, and how to supported, we can encourage and enable the advantages offered by this emerging modality.}
\osC{still need a closer}
