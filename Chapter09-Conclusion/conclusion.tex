...
%%%%%%%%%%%%%%%%%%
\subsection{General Design Activities: Browse, Sketch, Refine, and Share}
...
% SubSection - Schemas
%%%%%%%%%%%%%%%%%%
\subsection{Schemas for Users and Designers}
...
%%%%%%%%%%%%%%%%%%
\subsection{Flow, Learning, Scaffolding, and Embodiment}
...
% SubSection - Examples
%%%%%%%%%%%%%%%%%%
\subsection{Examples, demos, Show, don't tell}
...
%%%%%%%%%%%%%%%%%%
% SubSection - Transition into Mature Tools
%%%%%%%%%%%%%%%%%%
\subsection{Barriers, Walls, Ceilings: Transitioning into Mature Tools}
...
%
%%%%%%%%%%%%%%%%%%
\section{Notes on Implementing \haxd Tools}
