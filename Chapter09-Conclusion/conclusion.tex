...
Components - valuable for differnet views, different paradigms
Observer pattern + React is valuable for synchronizing different
JSON - flexibility, allows for easy extension, important for translating between different platforms, using features as available
noSQL (?)
...
Can have preview, buffering

Must support multimodal sensations

Multiple output devices, displays

Audio control useful, Arduino connection useful - but how to connect to web?

*****NEEDS ASSOCIATED HARDWARE *****, easy way to distribute it
Also - amplifiers and actuators matter
Closed loop control?

Logging and analytics not a problem; should record these features (from Macaron, a little Tactile Animation)

Android vibrations - how, hapticJS, web-based platform for handheld vibration, but need to accommodate differenet platforms
